  ...
  return (
    ...
    <section className='mt-60'>
      ...
      <Image
        ...
        <a href="https://resonant-torte-2e14de.netlify.app/" target="_blank"><h3 className='mt-6 mb-10 underline hover:text-blue-500'>Weather app</h3></a>
      </div> 
      ...
      <Image
        ...
        <a href="https://majestic-hamster-9b9378.netlify.app/" target="_blank"><h3 className='mt-6 mb-10 underline hover:text-blue-500'>Website about Pakistan</h3></a>
      </div>
      ...
      <Image
        ...
        <a href="https://flourishing-biscochitos-598d76.netlify.app/" target="_blank"><h3 className='mt-6 mb-10 underline hover:text-blue-500'>Own Portfolio with HTML,CSS,JS</h3></a>
      </div>
      ...
      <Image
        ...
        <a href="https://mellow-snickerdoodle-d72b23.netlify.app/" target="_blank"><h3 className='mt-6 mb-10 underline hover:text-blue-500'>Own Resume</h3></a>
      </div> 
