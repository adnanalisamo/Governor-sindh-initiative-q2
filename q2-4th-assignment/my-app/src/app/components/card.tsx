...
function StudentCard(props: StudentProps) {
  return (
    <div className="border-2 p-4 rounded-lg max-w-md w-full bg-amber-800 shadow-md">
       <h1 className="font-bold text-2xl mb-4 text-white text-center">Student ID Card</h1>
